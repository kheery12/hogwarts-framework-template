# Agent Interaction Protocols - Complete Reference

> **Load Trigger**: When coordinating between agents, houses, or managing handoffs
...
```
  ...
  (Inter-house coordination, contract negotiation)
    G-Pref -- R-Pref -- S-Pref -- H-Pref
        |        |        |        |
                SHARED RESOURCES
    Contracts | Marauder's Map | Pensieve
        |        |        |        |
...
### Prefect Council Meeting Process
...
Required before starting Year 3+ work.
...
### Breaking the Vow (Approved Deviation)
1. STOP immediately
