...
description: ALWAYS use for testing, security review, code review, and validation. Triggers on "test", "review", "check", "validate", "secure", "QA", "verify". The house that ensures nothing ships broken.
